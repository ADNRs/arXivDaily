...
def request_paper_with_arXiv_api(rule: str, max_results: int) -> List[Dict[str, str]]:
    url = "http://export.arxiv.org/api/query?search_query={0}&max_results={1}&sortBy=lastUpdatedDate".format(rule, max_results)
